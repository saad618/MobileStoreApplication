...
public class ProductController {
	...
	/*
	 * @GetMapping("product/highToLow") public List<Product>
	 * findingProductHighToLow() throws ProductException { return
	 * this.productService.findAllProductHighToLow(); }
	 * 
	 * 
	 * 
	 * 
	 * @GetMapping("product/lowToHigh") public List<Product>
	 * findingProductLowToHigh() throws ProductException { return
	 * this.productService.findAllProductLowToHigh(); }
	 * 
	 * 
	 * 
	 * 
	 * @GetMapping("products/{productName}") public Product
	 * findProductByName(@PathVariable("productName") String productName) throws
	 * ProductException { return this.productService.findProductByName(productName);
	 * }
	 */
