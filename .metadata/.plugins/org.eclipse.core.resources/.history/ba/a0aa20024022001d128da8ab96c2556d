...
public interface WishlistService {
    ...
    public String createWishlist(Wishlist wishlist) throws WishlistException,CustomerException;
	...
	public String addProductTOCartFromWishlist(Integer customerId,Integer productId) throws WishlistException,CustomerException, CartItemException, ProductException;
