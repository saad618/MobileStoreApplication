...
public class CustomerServiceImpl implements CustomerService {
    ...
    */
	...
	public String addCustomer(Customer customer) throws CustomerException {
		...
		Optional<Customer> yCustomer = this.customerRepository.findCustomerByUserName(customer.getUserName());
		if(yCustomer.isPresent()) throw new CustomerException("please try with other user name.");
...
@Override
public void loginByEmailOrUserName(String customer, String password) throws CustomerException {
	
	Optional<Customer> newCustomer = this.customerRepository.userDetails(customer);
	if(newCustomer.isEmpty()) throw new CustomerException("user not found.");
	Customer tempCustomer = newCustomer.get();
	Customer loginCustomer = this.customerRepository.findByCustomerIdAndPassword(tempCustomer.getCustomerId(), password);
	if (!(tempCustomer.getPassword().contentEquals(password)))
		throw new CustomerException("please enter correct password.");
