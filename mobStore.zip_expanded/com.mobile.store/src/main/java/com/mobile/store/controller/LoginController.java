...
public class LoginController {
	...
	@PostMapping("login-customer/email")
	public String customerLoginBYEmailOrUserName(@RequestBody Login login) throws CustomerException {
		String loginId = login.getLoginEmail();
		String password = login.getPassword();
		return this.loginService.customerLoginByEmailOrUserName(loginId, password);
	}
